...
class Ha(object):
            ...
            if self._async_executor.scheduled_action in (None, 'promote') \
                ...
                try:
                    ...
                    if not timeline:  # running as a standby
                        ...
                        timeline = self._last_timeline = self.state_handler.received_timeline()
                    if not timeline:
    ...
    def _is_healthiest_node(self, members: Collection[Member],
        ...
        my_timeline = self._last_timeline = self.state_handler.replica_cached_timeline(cluster_timeline)
