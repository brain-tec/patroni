...
class Postgresql(object):
    ...
    def pg_isready(self) -> PgIsReadyStatus:
        ...
        :returns: :cvar:`PgIsReadyStatus.RUNNING` value."""
    ...
    def follow(self, member: Union[Leader, Member, None], role: PostgresqlRole = PostgresqlRole.REPLICA,
        ...
        :param role: The desired role, one of :class:`PostgresqlRole` values, normally :cvar:`PostgresqlRole.REPLICA`,
            but could also be a :cvar:`PostgresqlRole.STANDBY_LEADER`
