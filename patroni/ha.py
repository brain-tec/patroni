...
class Ha(object):
    ...
    def follow(self, demote_reason: str, follow_reason: str, refresh: bool = True) -> str:
        ...
        role = PostgresqlRole.STANDBY_LEADER if isinstance(node_to_follow, RemoteMember) and self.has_lock(False) \
        ...
        if self.is_standby_cluster() and \
                role == PostgresqlRole.REPLICA and not (node_to_follow and node_to_follow.conn_url):
